    ...
    <div class="panel panel-body login-form">
      <div class="text-center">
        ...
        <h5 class="content-group">
          ...
          <small v-localize="{i: 'authorization.credentials'}" class="display-block"></small>
        </h5>
      </div>
      ...
      <div class="form-group has-feedback has-feedback-left">
        <input
          type="text"
          v-localize="{i: 'authorization.email', attr: 'placeholder'}"
          class="form-control"
          v-model="user.email"
      ...
      <div class="content-divider text-muted form-group">
        <span v-localize="{i: 'authorization.createNewMessage'}"></span>
      </div>
      <router-link
        to="/registr"
        class="btn btn-default btn-block content-group"
        v-localize="{i: 'authorization.signUp'}"
      ></router-link>
      ...
      <span class="help-block text-center no-margin">
        ...
        <a
          target="_blank"
          rel="noopener noreferrer"
          href="https://robotblob.blob.core.windows.net/robot-html-pages/CookiePolicy.html"
        >Cookie Policy</a>
      </span>
    </div>
  </div>
