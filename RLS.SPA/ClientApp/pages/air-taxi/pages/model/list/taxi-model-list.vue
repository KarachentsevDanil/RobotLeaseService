        ...
        <div class="page-header">
            <div class="page-header-content">
                <div class="page-title">
                    <h4><i class="icon-users2 position-left"></i> <span class="text-semibold" v-localize="{i: 'models.taxiModelList'}"></span></h4>

                    <ul class="breadcrumb position-right">
                        <li><a v-localize="{i: 'common.airTaxies'}"></a></li>
                        <li class="active" v-localize="{i: 'models.taxiModelList'}"></li>
                    </ul>
...
export default {
  ...
  methods: {
    async getTaxiModels() {
      ...
      let data = (await taxiModelService.getTaxiModelsByParams(params)).data
        .Data;
