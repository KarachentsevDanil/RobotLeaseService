<template>
    <!-- Primary modal -->
    <div id="addrobotType" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title" v-localize="{i: 'type.addrobotType'}"></h4>
                </div>
                ...
                <div class="modal-footer">
                    <button @click="addrobotType" type="button" :disabled="!this.name" class="btn btn-primary" v-localize="{i: 'common.add'}"></button>
...
export default {
  ...
  methods: {
    ...
    async addrobotType() {
      ...
      await robotTypeService.addrobotType(data);

      $(".close-add-popup").click();
      
      this.clearForm();
      this.$noty.success(this.$locale({i: 'type.robotTypeAdded'}));
