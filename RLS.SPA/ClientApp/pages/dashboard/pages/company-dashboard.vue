    ...
    <div class="content">
      <div class="row">
        <div class="col-md-6">
          <div class="panel panel-flat">
            <div class="panel-heading">
              <h5 class="panel-title">Top Robot Companies By Robot Count</h5>
            </div>
        ...
        <div class="col-md-6">
          <div class="panel panel-flat">
            <div class="panel-heading">
              <h5 class="panel-title">Top Robot Companies By Rent Count</h5>
            </div>
            <div class="panel-body">
              <pie-chart
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="panel panel-flat">
              <div class="panel-heading">
                <h5 class="panel-title">Top Robot Companies By Robot And Rent Count</h5>
              </div>
              <div class="panel-body">
